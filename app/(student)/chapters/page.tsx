...
export default function ChaptersPage() {
  ...
  if (loading) {
    return (
      <main dir="rtl" className="min-h-screen flex items-center justify-center bg-slate-950 text-white">
  ...
  return (
    <main dir="rtl" className="min-h-screen bg-slate-950 text-white relative overflow-hidden p-8 lg:p-12 text-right">
