                      ...
                      >
                        ...
                        <div className="flex-1 text-right">
                          ...
                          {option.image && (
                            <img
                              src={option.image}
                              alt={`صورة الاختيار ${option.key}`}
                              className="mt-3 max-h-[250px] max-w-full rounded-xl object-contain"
                              onError={(e) => {
                                console.error(
                                  `OPTION ${option.key} IMAGE LOAD ERROR:`,
                                  option.image
                                );
